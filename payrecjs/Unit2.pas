              ...
              for i:=1 to OracleDataSet1.RecordCount do
               begin
                   if empf=OracleDataSet1Emp.AsInteger
                     then //накапливаем массив по emp
                          zap_mas
                     else begin//новый emp
    ...
    begin
      if ((shop=dTmp[k].SHOP) and (EXPEND=dTmp[k].EXPEND))
          then  begin
                ...
                write(myFile, 'вставка emp ',IntToStr(empf));
                ...
                //накопление сумм для новых значений SHOP и EXPEND
